...
\vspace{2mm} %Some space
	...
	\runsubsection{Real-Time Vehicle Tracking and License Plate Recognition:}				\descript{Feb '16 - Present}	
	\begin{tightitemize}
	\small
	{
	\item \textbf{Course Project} for course \textbf{CS771A}: Machine Learning: Tools and Techniques, under \textbf{Prof. Harish Karnick}.
	\item Project aimed at \textbf{Real-time vehicle Tracking/Recognition} in real world surveillance videos.
	\item Proposed method involves performing \textbf{license plate detection} and further \textbf{transforming} the detected plate to gain a \textbf{frontal view}. 
	\item Using \textbf{OCR detection} along with pattern checks to extract the \textbf{Registration Number}.
	\item \textbf{Videos} used extracted from \textbf{security cameras} installed near Campus entry gates.
	}
	\end{tightitemize}
